...
function AdminHome() {
  ...
  const handleLogout=()=>{
    ...
    return(
        <div style={{backgroundColor:"rgba(255, 99, 71, 0.2)"}}>

            
            {/* <AdminNav/> */}
            <div>&ensp;</div>
            <div className="d-flex align-items-end mt-2" style={{ display: "flex", justifyContent: "flex-end",marginRight:"20px" }}>
                <button className="btn " style={{backgroundColor:"rgb(43,24,155)",color:"white"}} onClick={handleLogout}>Log out</button>
            </div>
                ...
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6">
                        <div class="card">
                            ...
                            <div class="card-footer d-flex justify-content-between">
                                <Link to={"/Admin/VoterList/"+id}><button class="btn" style={{backgroundColor:"rgb(43,24,155)",color:"white"}}>Voters List</button></Link>
                                <Link to={"/Admin/AddVoter/"+id}><button class="btn " style={{backgroundColor:"rgb(43,24,155)",color:"white"}}>Add Voters</button></Link>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card">
                            ...
                            <div class="card-footer d-flex justify-content-between">
                                <Link to={"/Admin/PartyList/"+id}><button class="btn " style={{backgroundColor:"rgb(43,24,155)",color:"white"}}>Parties List</button></Link>
                                <Link to={"/Admin/AddParty/"+id}><button class="btn " style={{backgroundColor:"rgb(43,24,155)",color:"white"}}>Add Parties</button></Link>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card">
                            ...
                            <div class="card-footer d-flex justify-content-center">
                                <Link to={"/Admin/IsVotedList/"+id}><button class="btn" style={{backgroundColor:"rgb(43,24,155)",color:"white"}}>Voted List</button></Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card">
                            ...
                            <div class="card-footer d-flex justify-content-center">
                                <Link to={"/Admin/Results/"+id}><button class="btn " style={{backgroundColor:"rgb(43,24,155)",color:"white"}}>Results</button></Link>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card">
                            ...
                            <div class="card-footer d-flex justify-content-center">
                                <Link to={"/Admin/Profile/"+id}><button class="btn " style={{backgroundColor:"rgb(43,24,155)",color:"white"}}>Profile</button></Link>
                            </div>
                        </div>
                    ...
                    {id === "654718d311503067da7ec963" && (<div class="col-lg-4 col-md-6">
                        <div class="card">
                            ...
                            <div class="card-footer d-flex justify-content-center">
                                <Link to={"/Admin/AdminsList/"+id}><button class="btn " style={{backgroundColor:"rgb(43,24,155)",color:"white"}}>Manage Admins</button></Link>
                            </div>
                        </div>
